...
| **Claim 2** | TTT layer streaming memory fast-weight updates & prediction loss | `toy` | Synthetic sequence prediction loss=0.5173 computed across timesteps with fast-weight matrix updates. |
...
- **Memory Dimension:** 64
- **Mean Synthetic Prediction MSE Loss:** 0.5173
