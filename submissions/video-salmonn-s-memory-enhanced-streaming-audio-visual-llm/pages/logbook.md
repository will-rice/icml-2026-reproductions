...
| **Claim 2** | TTT layer streaming memory fast-weight updates & prediction loss | `toy` | Synthetic sequence prediction loss=0.2176 computed across timesteps with fast-weight matrix updates. |
...
- **Hidden Dimension:** 16
- **Memory Dimension:** 8
- **Mean Synthetic Prediction MSE Loss:** 0.2176
