import{t as e}from"./shaderStore-D-XQlhUT.js";import"./clipPlaneFragment-CSA2ud-B.js";import"./helperFunctions-CM1SYQ_G.js";import"./backgroundUboDeclaration-DBFuh3xm.js";import"./shadowsFragmentFunctions-C_KNiUjW.js";import"./imageProcessingFunctions-BLS7cm_w.js";import"./lightFragment-Df1zfVTQ.js";import"./lightsFragmentFunctions-CnzV-WCc.js";import"./logDepthDeclaration--laj1kHT.js";import"./fogFragment-D_7zXuQT.js";var t=`backgroundFragmentDeclaration`,n=`uniform vec4 vEyePosition;uniform vec4 vPrimaryColor;
...
#endif
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=n);var r=`intersectionFunctions`,i=`float diskIntersectWithBackFaceCulling(vec3 ro,vec3 rd,vec3 c,float r) {float d=rd.y;if(d>0.0) { return 1e6; }
...
h=sqrt(h);return vec2(-b+h,-b-h);}`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=i);var a=`backgroundPixelShader`,o=`#ifdef TEXTURELODSUPPORT
...
`;e.ShadersStore[a]||(e.ShadersStore[a]=o);var s={name:a,shader:o};export{s as backgroundPixelShader};