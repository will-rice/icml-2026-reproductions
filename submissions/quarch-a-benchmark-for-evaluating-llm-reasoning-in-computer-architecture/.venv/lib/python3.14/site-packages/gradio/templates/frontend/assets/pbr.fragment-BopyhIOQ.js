import{t as e}from"./shaderStore-D-XQlhUT.js";import"./helperFunctions-DquCMwzt.js";import"./decalFragment-CpaPTi-j.js";import"./shadowsFragmentFunctions-BgJ0vxEO.js";import"./imageProcessingFunctions-CeTUCCB6.js";import"./logDepthDeclaration-B8O1rFmO.js";import"./clipPlaneFragment-DGqZJNeS.js";import"./fogFragment-DT_vR29_.js";import"./lightFragment-CQfr187C.js";import"./oitFragment-CawmeOig.js";import"./samplerFragmentDeclaration-I1t02tES.js";import"./bumpFragment-CAlQ_ztm.js";import"./hdrFilteringFunctions-BkNCmHAK.js";import"./pbrBRDFFunctions-DiT7LTSA.js";import"./pbrDebug-Dcenycev.js";import"./harmonicsFunctions-CteL0VSC.js";import"./pbrUboDeclaration-6SnOWTp5.js";var t=`samplerFragmentAlternateDeclaration`,n=`#ifdef _DEFINENAME_
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[t]||(e.IncludesShadersStoreWGSL[t]=n);var r=`pbrFragmentSamplersDeclaration`,i=`#include<samplerFragmentDeclaration>(_DEFINENAME_,ALBEDO,_VARYINGNAME_,Albedo,_SAMPLERNAME_,albedo)
...
#endif
`;e.IncludesShadersStoreWGSL[r]||(e.IncludesShadersStoreWGSL[r]=i);var a=`pbrBlockAlbedoOpacity`,o=`struct albedoOpacityOutParams
{surfaceAlbedo: vec3f,
alpha: f32};
#define pbr_inline
...
`;e.IncludesShadersStoreWGSL[a]||(e.IncludesShadersStoreWGSL[a]=o);var s=`pbrBlockReflectivity`,c=`struct reflectivityOutParams
{microSurface: f32,
roughness: f32,
...
`;e.IncludesShadersStoreWGSL[s]||(e.IncludesShadersStoreWGSL[s]=c);var l=`pbrBlockAmbientOcclusion`,u=`struct ambientOcclusionOutParams
{ambientOcclusionColor: vec3f,
...
`;e.IncludesShadersStoreWGSL[l]||(e.IncludesShadersStoreWGSL[l]=u);var d=`pbrBlockAlphaFresnel`,f=`#ifdef ALPHAFRESNEL
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[d]||(e.IncludesShadersStoreWGSL[d]=f);var p=`pbrBlockAnisotropic`,m=`#ifdef ANISOTROPIC
...
#endif
`;e.IncludesShadersStoreWGSL[p]||(e.IncludesShadersStoreWGSL[p]=m);var h=`pbrBlockReflection`,g=`#ifdef REFLECTION
...
#endif
`;e.IncludesShadersStoreWGSL[h]||(e.IncludesShadersStoreWGSL[h]=g);var _=`pbrBlockSheen`,v=`#ifdef SHEEN
...
#endif
`;e.IncludesShadersStoreWGSL[_]||(e.IncludesShadersStoreWGSL[_]=v);var y=`pbrBlockClearcoat`,b=`struct clearcoatOutParams
...
return outParams;}
#endif
`;e.IncludesShadersStoreWGSL[y]||(e.IncludesShadersStoreWGSL[y]=b);var x=`pbrBlockIridescence`,S=`struct iridescenceOutParams
...
#endif
`;e.IncludesShadersStoreWGSL[x]||(e.IncludesShadersStoreWGSL[x]=S);var C=`pbrBlockSubSurface`,w=`struct subSurfaceOutParams
...
return outParams;}
#endif
`;e.IncludesShadersStoreWGSL[C]||(e.IncludesShadersStoreWGSL[C]=w);var T=`pbrBlockNormalFinal`,E=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[T]||(e.IncludesShadersStoreWGSL[T]=E);var D=`pbrBlockLightmapInit`,O=`#ifdef LIGHTMAP
...
#endif
`;e.IncludesShadersStoreWGSL[D]||(e.IncludesShadersStoreWGSL[D]=O);var k=`pbrBlockGeometryInfo`,A=`var NdotVUnclamped: f32=dot(normalW,viewDirectionW);var NdotV: f32=absEps(NdotVUnclamped);var alphaG: f32=convertRoughnessToAverageSlope(roughness);var AARoughnessFactors: vec2f=getAARoughnessFactors(normalW.xyz);
#ifdef SPECULARAA
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[k]||(e.IncludesShadersStoreWGSL[k]=A);var j=`pbrBlockReflectance`,M=`#if defined(ENVIRONMENTBRDF) && !defined(REFLECTIONMAP_SKYBOX)
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[j]||(e.IncludesShadersStoreWGSL[j]=M);var N=`pbrBlockDirectLighting`,P=`var diffuseBase: vec3f=vec3f(0.,0.,0.);
#ifdef SS_TRANSLUCENCY
...
#endif
`;e.IncludesShadersStoreWGSL[N]||(e.IncludesShadersStoreWGSL[N]=P);var F=`pbrBlockFinalLitComponents`,I=`aggShadow=aggShadow/numLights;
#if defined(ENVIRONMENTBRDF)
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[F]||(e.IncludesShadersStoreWGSL[F]=I);var L=`pbrBlockFinalUnlitComponents`,R=`var finalDiffuse: vec3f=diffuseBase;finalDiffuse*=surfaceAlbedo;
...
`;e.IncludesShadersStoreWGSL[L]||(e.IncludesShadersStoreWGSL[L]=R);var z=`pbrBlockFinalColorComposition`,B=`var finalColor: vec4f= vec4f(
#ifndef UNLIT
#ifdef REFLECTION
finalIrradiance +
#endif
...
`;e.IncludesShadersStoreWGSL[z]||(e.IncludesShadersStoreWGSL[z]=B);var V=`pbrPixelShader`,H=`#define PBR_FRAGMENT_SHADER
...
`;e.ShadersStoreWGSL[V]||(e.ShadersStoreWGSL[V]=H);var U={name:V,shader:H};export{U as pbrPixelShaderWGSL};