import{t as e}from"./shaderStore-D-XQlhUT.js";var t=`iblCdfxPixelShader`,n=`precision highp sampler2D;
#define PI 3.1415927
...
gl_FragColor=vec4(vec3(cdfx),1.0);}`;e.ShadersStore[t]||(e.ShadersStore[t]=n);var r={name:t,shader:n};export{r as iblCdfxPixelShader};