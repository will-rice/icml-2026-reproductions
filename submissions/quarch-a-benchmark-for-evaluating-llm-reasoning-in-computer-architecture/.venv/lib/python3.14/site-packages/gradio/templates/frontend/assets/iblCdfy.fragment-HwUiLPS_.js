import{t as e}from"./shaderStore-D-XQlhUT.js";var t=`iblCdfyPixelShader`,n=`varying vUV : vec2f;
...
fragmentOutputs.color= vec4f(cdfy,0.0,0.0,1.0);}`;e.ShadersStoreWGSL[t]||(e.ShadersStoreWGSL[t]=n);var r={name:t,shader:n};export{r as iblCdfyPixelShaderWGSL};