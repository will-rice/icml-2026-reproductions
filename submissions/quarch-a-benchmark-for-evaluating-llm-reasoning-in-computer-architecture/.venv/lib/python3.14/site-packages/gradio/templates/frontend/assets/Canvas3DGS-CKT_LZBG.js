...
`,W=class extends P{constructor(e,t){super(e,t),this._outlineThickness=10,this._outlineColor=new B(255,165,0,255),this._renderData=null,this._depthIndex=new Uint32Array,this._splatTexture=null,this._worker=null;let n=e.canvas,r=e.gl,i,a,o,s,c,l,u,d,f,p,m,h,g,_,v,y,b,x,S;this._resize=()=>{this._camera&&(this._camera.data.setSize(n.width,n.height),this._camera.update(),i=r.getUniformLocation(this.program,`projection`),r.uniformMatrix4fv(i,!1,this._camera.data.projectionMatrix.buffer),a=r.getUniformLocation(this.program,`viewport`),r.uniform2fv(a,new Float32Array([n.width,n.height])))};let w=()=>{this._worker=V(),this._worker.onmessage=e=>{if(e.data.depthIndex){let{depthIndex:t}=e.data;this._depthIndex=t,r.bindBuffer(r.ARRAY_BUFFER,S),r.bufferData(r.ARRAY_BUFFER,t,r.STATIC_DRAW)}}};this._initialize=()=>{if(!this._scene||!this._camera){console.error(`Cannot render without scene and camera`);return}this._resize(),this._scene.addEventListener(`objectAdded`,T),this._scene.addEventListener(`objectRemoved`,E);for(let e of this._scene.objects)e instanceof C&&e.addEventListener(`objectChanged`,D);this._renderData=new z(this._scene),o=r.getUniformLocation(this.program,`focal`),r.uniform2fv(o,new Float32Array([this._camera.data.fx,this._camera.data.fy])),s=r.getUniformLocation(this.program,`view`),r.uniformMatrix4fv(s,!1,this._camera.data.viewMatrix.buffer),p=r.getUniformLocation(this.program,`outlineThickness`),r.uniform1f(p,this.outlineThickness),m=r.getUniformLocation(this.program,`outlineColor`),r.uniform4fv(m,new Float32Array(this.outlineColor.flatNorm())),this._splatTexture=r.createTexture(),c=r.getUniformLocation(this.program,`u_texture`),r.uniform1i(c,0),_=r.createTexture(),l=r.getUniformLocation(this.program,`u_transforms`),r.uniform1i(l,1),v=r.createTexture(),u=r.getUniformLocation(this.program,`u_transformIndices`),r.uniform1i(u,2),y=r.createTexture(),d=r.getUniformLocation(this.program,`u_colorTransforms`),r.uniform1i(d,3),b=r.createTexture(),f=r.getUniformLocation(this.program,`u_colorTransformIndices`),r.uniform1i(f,4),x=r.createBuffer(),r.bindBuffer(r.ARRAY_BUFFER,x),r.bufferData(r.ARRAY_BUFFER,new Float32Array([-2,-2,2,-2,2,2,-2,2]),r.STATIC_DRAW),h=r.getAttribLocation(this.program,`position`),r.enableVertexAttribArray(h),r.vertexAttribPointer(h,2,r.FLOAT,!1,0,0),S=r.createBuffer(),g=r.getAttribLocation(this.program,`index`),r.enableVertexAttribArray(g),r.bindBuffer(r.ARRAY_BUFFER,S),w()};let T=e=>{let t=e;t.object instanceof C&&t.object.addEventListener(`objectChanged`,D),O()},E=e=>{let t=e;t.object instanceof C&&t.object.removeEventListener(`objectChanged`,D),O()},D=e=>{let t=e;t.object instanceof C&&this._renderData&&this._renderData.markDirty(t.object)},O=()=>{this._renderData?.dispose(),this._renderData=new z(this._scene),this._worker?.terminate(),w()};this._render=()=>{if(!this._scene||!this._camera||!this.renderData){console.error(`Cannot render without scene and camera`);return}if(this.renderData.needsRebuild&&this.renderData.rebuild(),this.renderData.dataChanged||this.renderData.transformsChanged||this.renderData.colorTransformsChanged){this.renderData.dataChanged&&(r.activeTexture(r.TEXTURE0),r.bindTexture(r.TEXTURE_2D,this.splatTexture),r.texParameteri(r.TEXTURE_2D,r.TEXTURE_WRAP_S,r.CLAMP_TO_EDGE),r.texParameteri(r.TEXTURE_2D,r.TEXTURE_WRAP_T,r.CLAMP_TO_EDGE),r.texParameteri(r.TEXTURE_2D,r.TEXTURE_MIN_FILTER,r.NEAREST),r.texParameteri(r.TEXTURE_2D,r.TEXTURE_MAG_FILTER,r.NEAREST),r.texImage2D(r.TEXTURE_2D,0,r.RGBA32UI,this.renderData.width,this.renderData.height,0,r.RGBA_INTEGER,r.UNSIGNED_INT,this.renderData.data)),this.renderData.transformsChanged&&(r.activeTexture(r.TEXTURE1),r.bindTexture(r.TEXTURE_2D,_),r.texParameteri(r.TEXTURE_2D,r.TEXTURE_WRAP_S,r.CLAMP_TO_EDGE),r.texParameteri(r.TEXTURE_2D,r.TEXTURE_WRAP_T,r.CLAMP_TO_EDGE),r.texParameteri(r.TEXTURE_2D,r.TEXTURE_MIN_FILTER,r.NEAREST),r.texParameteri(r.TEXTURE_2D,r.TEXTURE_MAG_FILTER,r.NEAREST),r.texImage2D(r.TEXTURE_2D,0,r.RGBA32F,this.renderData.transformsWidth,this.renderData.transformsHeight,0,r.RGBA,r.FLOAT,this.renderData.transforms),r.activeTexture(r.TEXTURE2),r.bindTexture(r.TEXTURE_2D,v),r.texParameteri(r.TEXTURE_2D,r.TEXTURE_WRAP_S,r.CLAMP_TO_EDGE),r.texParameteri(r.TEXTURE_2D,r.TEXTURE_WRAP_T,r.CLAMP_TO_EDGE),r.texParameteri(r.TEXTURE_2D,r.TEXTURE_MIN_FILTER,r.NEAREST),r.texParameteri(r.TEXTURE_2D,r.TEXTURE_MAG_FILTER,r.NEAREST),r.texImage2D(r.TEXTURE_2D,0,r.R32UI,this.renderData.transformIndicesWidth,this.renderData.transformIndicesHeight,0,r.RED_INTEGER,r.UNSIGNED_INT,this.renderData.transformIndices)),this.renderData.colorTransformsChanged&&(r.activeTexture(r.TEXTURE3),r.bindTexture(r.TEXTURE_2D,y),r.texParameteri(r.TEXTURE_2D,r.TEXTURE_WRAP_S,r.CLAMP_TO_EDGE),r.texParameteri(r.TEXTURE_2D,r.TEXTURE_WRAP_T,r.CLAMP_TO_EDGE),r.texParameteri(r.TEXTURE_2D,r.TEXTURE_MIN_FILTER,r.NEAREST),r.texParameteri(r.TEXTURE_2D,r.TEXTURE_MAG_FILTER,r.NEAREST),r.texImage2D(r.TEXTURE_2D,0,r.RGBA32F,this.renderData.colorTransformsWidth,this.renderData.colorTransformsHeight,0,r.RGBA,r.FLOAT,this.renderData.colorTransforms),r.activeTexture(r.TEXTURE4),r.bindTexture(r.TEXTURE_2D,b),r.texParameteri(r.TEXTURE_2D,r.TEXTURE_WRAP_S,r.CLAMP_TO_EDGE),r.texParameteri(r.TEXTURE_2D,r.TEXTURE_WRAP_T,r.CLAMP_TO_EDGE),r.texParameteri(r.TEXTURE_2D,r.TEXTURE_MIN_FILTER,r.NEAREST),r.texParameteri(r.TEXTURE_2D,r.TEXTURE_MAG_FILTER,r.NEAREST),r.texImage2D(r.TEXTURE_2D,0,r.R32UI,this.renderData.colorTransformIndicesWidth,this.renderData.colorTransformIndicesHeight,0,r.RED_INTEGER,r.UNSIGNED_INT,this.renderData.colorTransformIndices));let e=new Float32Array(this.renderData.positions.slice().buffer),t=new Float32Array(this.renderData.transforms.slice().buffer),n=new Uint32Array(this.renderData.transformIndices.slice().buffer);this._worker?.postMessage({sortData:{positions:e,transforms:t,transformIndices:n,vertexCount:this.renderData.vertexCount}},[e.buffer,t.buffer,n.buffer]),this.renderData.dataChanged=!1,this.renderData.transformsChanged=!1,this.renderData.colorTransformsChanged=!1}this._camera.update(),this._worker?.postMessage({viewProj:this._camera.data.viewProj.buffer}),r.viewport(0,0,n.width,n.height),r.clearColor(0,0,0,0),r.clear(r.COLOR_BUFFER_BIT),r.disable(r.DEPTH_TEST),r.enable(r.BLEND),r.blendFuncSeparate(r.ONE_MINUS_DST_ALPHA,r.ONE,r.ONE_MINUS_DST_ALPHA,r.ONE),r.blendEquationSeparate(r.FUNC_ADD,r.FUNC_ADD),r.uniformMatrix4fv(i,!1,this._camera.data.projectionMatrix.buffer),r.uniformMatrix4fv(s,!1,this._camera.data.viewMatrix.buffer),r.bindBuffer(r.ARRAY_BUFFER,x),r.vertexAttribPointer(h,2,r.FLOAT,!1,0,0),r.bindBuffer(r.ARRAY_BUFFER,S),r.bufferData(r.ARRAY_BUFFER,this.depthIndex,r.STATIC_DRAW),r.vertexAttribIPointer(g,1,r.INT,0,0),r.vertexAttribDivisor(g,1),r.drawArraysInstanced(r.TRIANGLE_FAN,0,4,this.depthIndex.length)},this._dispose=()=>{if(!this._scene||!this._camera||!this.renderData){console.error(`Cannot dispose without scene and camera`);return}this._scene.removeEventListener(`objectAdded`,T),this._scene.removeEventListener(`objectRemoved`,E);for(let e of this._scene.objects)e instanceof C&&e.removeEventListener(`objectChanged`,D);this._worker?.terminate(),this.renderData.dispose(),r.deleteTexture(this.splatTexture),r.deleteTexture(_),r.deleteTexture(v),r.deleteBuffer(S),r.deleteBuffer(x)},this._setOutlineThickness=e=>{this._outlineThickness=e,this._initialized&&r.uniform1f(p,e)},this._setOutlineColor=e=>{this._outlineColor=e,this._initialized&&r.uniform4fv(m,new Float32Array(e.flatNorm()))}}get renderData(){return this._renderData}get depthIndex(){return this._depthIndex}get splatTexture(){return this._splatTexture}get outlineThickness(){return this._outlineThickness}set outlineThickness(e){this._setOutlineThickness(e)}get outlineColor(){return this._outlineColor}set outlineColor(e){this._setOutlineColor(e)}get worker(){return this._worker}_getVertexSource(){return H}_getFragmentSource(){return U}},G=class{constructor(e=1){let t=0,n=!1,r,i,a,o;this.initialize=e=>{if(!(e instanceof W))throw Error(`FadeInPass requires a RenderProgram`);t=+!!e.started,n=!0,r=e,i=e.renderer.gl,a=i.getUniformLocation(r.program,`useDepthFade`),i.uniform1i(a,1),o=i.getUniformLocation(r.program,`depthFade`),i.uniform1f(o,t)},this.render=()=>{!n||r.renderData?.updating||(i.useProgram(r.program),t=Math.min(t+e*.01,1),t>=1&&(n=!1,i.uniform1i(a,0)),i.uniform1f(o,t))}}dispose(){}},K=class{constructor(e=null,t=null){this._backgroundColor=new B;let n=e||document.createElement(`canvas`);e||(n.style.display=`block`,n.style.boxSizing=`border-box`,n.style.width=`100%`,n.style.height=`100%`,n.style.margin=`0`,n.style.padding=`0`,document.body.appendChild(n)),n.style.background=this._backgroundColor.toHexString(),this._canvas=n,this._gl=n.getContext(`webgl2`,{antialias:!1});let r=t||[];t||r.push(new G),this._renderProgram=new W(this,r);let i=[this._renderProgram];this.resize=()=>{let e=n.clientWidth,t=n.clientHeight;(n.width!==e||n.height!==t)&&this.setSize(e,t)},this.setSize=(e,t)=>{n.width=e,n.height=t,this._gl.viewport(0,0,n.width,n.height);for(let e of i)e.resize()},this.render=(e,t)=>{for(let n of i)n.render(e,t)},this.dispose=()=>{for(let e of i)e.dispose()},this.addProgram=e=>{i.push(e)},this.removeProgram=e=>{let t=i.indexOf(e);if(t<0)throw Error(`Program not found`);i.splice(t,1)},this.resize()}get canvas(){return this._canvas}get gl(){return this._gl}get renderProgram(){return this._renderProgram}get backgroundColor(){return this._backgroundColor}set backgroundColor(e){this._backgroundColor=e,this._canvas.style.background=e.toHexString()}},q=class{constructor(e,t,n=.5,r=.5,i=5,a=!0,o=new d){this.minAngle=-90,this.maxAngle=90,this.minZoom=.1,this.maxZoom=30,this.orbitSpeed=1,this.panSpeed=1,this.zoomSpeed=1,this.dampening=.12,this.setCameraTarget=()=>{};let s=o.clone(),c=s.clone(),l=n,u=r,p=i,m=!1,h=!1,g=0,_=0,v=0,b={},x=!1;e.addEventListener(`objectChanged`,()=>{if(x)return;let t=e.rotation.toEuler();l=-t.y,u=-t.x,c=new d(e.position.x-p*Math.sin(l)*Math.cos(u),e.position.y+p*Math.sin(u),e.position.z+p*Math.cos(l)*Math.cos(u))}),this.setCameraTarget=t=>{let n=t.x-e.position.x,r=t.y-e.position.y,i=t.z-e.position.z;p=Math.sqrt(n*n+r*r+i*i),u=Math.atan2(r,Math.sqrt(n*n+i*i)),l=-Math.atan2(n,i),c=new d(t.x,t.y,t.z)};let S=()=>.1+.9*(p-this.minZoom)/(this.maxZoom-this.minZoom),C=e=>{b[e.code]=!0,e.code===`ArrowUp`&&(b.KeyW=!0),e.code===`ArrowDown`&&(b.KeyS=!0),e.code===`ArrowLeft`&&(b.KeyA=!0),e.code===`ArrowRight`&&(b.KeyD=!0)},w=e=>{b[e.code]=!1,e.code===`ArrowUp`&&(b.KeyW=!1),e.code===`ArrowDown`&&(b.KeyS=!1),e.code===`ArrowLeft`&&(b.KeyA=!1),e.code===`ArrowRight`&&(b.KeyD=!1)},T=e=>{N(e),m=!0,h=e.button===2,_=e.clientX,v=e.clientY,window.addEventListener(`mouseup`,E)},E=e=>{N(e),m=!1,h=!1,window.removeEventListener(`mouseup`,E)},D=t=>{if(N(t),!m||!e)return;let n=t.clientX-_,r=t.clientY-v;if(h){let t=S(),i=-n*this.panSpeed*.01*t,a=-r*this.panSpeed*.01*t,o=y.RotationFromQuaternion(e.rotation).buffer,s=new d(o[0],o[3],o[6]),l=new d(o[1],o[4],o[7]);c=c.add(s.multiply(i)),c=c.add(l.multiply(a))}else l-=n*this.orbitSpeed*.003,u+=r*this.orbitSpeed*.003,u=Math.min(Math.max(u,this.minAngle*Math.PI/180),this.maxAngle*Math.PI/180);_=t.clientX,v=t.clientY},O=e=>{N(e);let t=S();p+=e.deltaY*this.zoomSpeed*.025*t,p=Math.min(Math.max(p,this.minZoom),this.maxZoom)},k=e=>{if(N(e),e.touches.length===1)m=!0,h=!1,_=e.touches[0].clientX,v=e.touches[0].clientY,g=0;else if(e.touches.length===2){m=!0,h=!0,_=(e.touches[0].clientX+e.touches[1].clientX)/2,v=(e.touches[0].clientY+e.touches[1].clientY)/2;let t=e.touches[0].clientX-e.touches[1].clientX,n=e.touches[0].clientY-e.touches[1].clientY;g=Math.sqrt(t*t+n*n)}},A=e=>{N(e),m=!1,h=!1},j=t=>{if(N(t),!(!m||!e))if(h){let n=S(),r=t.touches[0].clientX-t.touches[1].clientX,i=t.touches[0].clientY-t.touches[1].clientY,a=Math.sqrt(r*r+i*i),o=g-a;p+=o*this.zoomSpeed*.1*n,p=Math.min(Math.max(p,this.minZoom),this.maxZoom),g=a;let s=(t.touches[0].clientX+t.touches[1].clientX)/2,l=(t.touches[0].clientY+t.touches[1].clientY)/2,u=s-_,f=l-v,m=y.RotationFromQuaternion(e.rotation).buffer,h=new d(m[0],m[3],m[6]),b=new d(m[1],m[4],m[7]);c=c.add(h.multiply(-u*this.panSpeed*.025*n)),c=c.add(b.multiply(-f*this.panSpeed*.025*n)),_=s,v=l}else{let e=t.touches[0].clientX-_,n=t.touches[0].clientY-v;l-=e*this.orbitSpeed*.003,u+=n*this.orbitSpeed*.003,u=Math.min(Math.max(u,this.minAngle*Math.PI/180),this.maxAngle*Math.PI/180),_=t.touches[0].clientX,v=t.touches[0].clientY}},M=(e,t,n)=>(1-n)*e+n*t;this.update=()=>{x=!0,n=M(n,l,this.dampening),r=M(r,u,this.dampening),i=M(i,p,this.dampening),s=s.lerp(c,this.dampening),e.position=new d(s.x+i*Math.sin(n)*Math.cos(r),s.y-i*Math.sin(r),s.z-i*Math.cos(n)*Math.cos(r));let t=s.subtract(e.position).normalize(),a=Math.asin(-t.y),o=Math.atan2(t.x,t.z);e.rotation=f.FromEuler(new d(a,o,0));let m=.025,h=.01,g=y.RotationFromQuaternion(e.rotation).buffer,_=new d(-g[2],-g[5],-g[8]),v=new d(g[0],g[3],g[6]);b.KeyS&&(c=c.add(_.multiply(m))),b.KeyW&&(c=c.subtract(_.multiply(m))),b.KeyA&&(c=c.subtract(v.multiply(m))),b.KeyD&&(c=c.add(v.multiply(m))),b.KeyE&&(l+=h),b.KeyQ&&(l-=h),b.KeyR&&(u+=h),b.KeyF&&(u-=h),x=!1};let N=e=>{e.preventDefault(),e.stopPropagation()};this.dispose=()=>{t.removeEventListener(`dragenter`,N),t.removeEventListener(`dragover`,N),t.removeEventListener(`dragleave`,N),t.removeEventListener(`contextmenu`,N),t.removeEventListener(`mousedown`,T),t.removeEventListener(`mousemove`,D),t.removeEventListener(`wheel`,O),t.removeEventListener(`touchstart`,k),t.removeEventListener(`touchend`,A),t.removeEventListener(`touchmove`,j),a&&(window.removeEventListener(`keydown`,C),window.removeEventListener(`keyup`,w))},a&&(window.addEventListener(`keydown`,C),window.addEventListener(`keyup`,w)),t.addEventListener(`dragenter`,N),t.addEventListener(`dragover`,N),t.addEventListener(`dragleave`,N),t.addEventListener(`contextmenu`,N),t.addEventListener(`mousedown`,T),t.addEventListener(`mousemove`,D),t.addEventListener(`wheel`,O),t.addEventListener(`touchstart`,k),t.addEventListener(`touchend`,A),t.addEventListener(`touchmove`,j),this.update()}},J=a(`<canvas></canvas>`);function Y(a,d){i(d,!0);let f=n(()=>d.value.url),p,m,h,g=null,_,v=e(!1),y=null;function b(){if(y!==null&&(cancelAnimationFrame(y),y=null),g!==null&&(g.dispose(),g=null),m=new D,h=new E,g=new K(p),_=new q(h,p),_.zoomSpeed=d.zoom_speed,_.panSpeed=d.pan_speed,!d.value)return;let e=!1,t=async()=>{if(e){console.error(`Already loading`);return}if(!o(f))throw Error(`No resolved URL`);if(e=!0,o(f).endsWith(`.ply`))await j.LoadAsync(o(f),m,void 0);else if(o(f).endsWith(`.splat`))await A.LoadAsync(o(f),m,void 0);else throw Error(`Unsupported file type`);e=!1},n=()=>{if(g){if(e){y=requestAnimationFrame(n);return}_.update(),g.render(m,h),y=requestAnimationFrame(n)}};t(),y=requestAnimationFrame(n)}c(()=>(d.value!=null&&b(),u(v,!0),()=>{g&&g.dispose()}));let x=n(()=>d.value?.path);t(()=>{p&&o(v)&&o(x)&&b()});var S=J();l(S,e=>p=e,()=>p),s(a,S),r()}export{Y as default};
