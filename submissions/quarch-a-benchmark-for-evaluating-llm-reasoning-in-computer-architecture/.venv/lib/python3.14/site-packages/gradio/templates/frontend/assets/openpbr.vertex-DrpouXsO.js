import{t as e}from"./shaderStore-D-XQlhUT.js";import"./instancesVertex-BN7clrit.js";import"./bakedVertexAnimation-DS-FWsHx.js";import"./instancesDeclaration-DWorEgDR.js";import"./helperFunctions-DquCMwzt.js";import"./logDepthDeclaration-B8O1rFmO.js";import"./bonesDeclaration-B7wjhknY.js";import"./clipPlaneVertex-gMyNlLVT.js";import"./logDepthVertex-B7eOEYaq.js";import"./shadowsVertex-giKuWlFo.js";import"./bonesVertex-BIfu6COM.js";import"./mainUVVaryingDeclaration-Bi-owTpY.js";import"./vertexColorMixing-p8rh7oMH.js";import"./morphTargetsVertexDeclaration-C19K6Bin.js";import"./morphTargetsVertex-BRUNyA6N.js";import"./pbrBRDFFunctions-DiT7LTSA.js";import"./openpbrUboDeclaration-DDVgYCbX.js";import"./harmonicsFunctions-CteL0VSC.js";var t=`openpbrNormalMapVertexDeclaration`,n=`#if defined(GEOMETRY_NORMAL) || defined(PARALLAX) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC) || defined(FUZZ)
#if defined(TANGENT) && defined(NORMAL) 
varying vTBN0: vec3f;varying vTBN1: vec3f;varying vTBN2: vec3f;
#endif
#endif
`;e.IncludesShadersStoreWGSL[t]||(e.IncludesShadersStoreWGSL[t]=n);var r=`openpbrNormalMapVertex`,i=`#if defined(GEOMETRY_NORMAL) || defined(PARALLAX) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC) || defined(FUZZ)
#if defined(TANGENT) && defined(NORMAL)
var tbnNormal: vec3f=normalize(normalUpdated);var tbnTangent: vec3f=normalize(tangentUpdated.xyz);var tbnBitangent: vec3f=cross(tbnNormal,tbnTangent)*tangentUpdated.w;var matTemp= mat3x3f(finalWorld[0].xyz,finalWorld[1].xyz,finalWorld[2].xyz)* mat3x3f(tbnTangent,tbnBitangent,tbnNormal);vertexOutputs.vTBN0=matTemp[0];vertexOutputs.vTBN1=matTemp[1];vertexOutputs.vTBN2=matTemp[2];
#endif
#endif
`;e.IncludesShadersStoreWGSL[r]||(e.IncludesShadersStoreWGSL[r]=i);var a=`openpbrVertexShader`,o=`#define OPENPBR_VERTEX_SHADER
...
}`;e.ShadersStoreWGSL[a]||(e.ShadersStoreWGSL[a]=o);var s={name:a,shader:o};export{s as openpbrVertexShaderWGSL};