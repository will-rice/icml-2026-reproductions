import{t as e}from"./shaderStore-D-XQlhUT.js";import"./clipPlaneFragment-CSA2ud-B.js";import"./samplerFragmentDeclaration-Ddqenr6W.js";import"./helperFunctions-CM1SYQ_G.js";import"./shadowsFragmentFunctions-C_KNiUjW.js";import"./imageProcessingFunctions-BLS7cm_w.js";import"./logDepthDeclaration--laj1kHT.js";import"./fogFragment-D_7zXuQT.js";import"./oitFragment-0kNY9gqU.js";import"./hdrFilteringFunctions-BK6JpkMG.js";import"./pbrBRDFFunctions-C40dSicq.js";import"./openpbrUboDeclaration-DumNXqe_.js";import"./pbrDebug-Bc7QUwIL.js";import"./harmonicsFunctions-DQ8vBbkT.js";var t=`openpbrFragmentDeclaration`,n=`uniform vec4 vEyePosition;uniform float vBaseWeight;uniform vec4 vBaseColor;uniform float vBaseDiffuseRoughness;uniform vec4 vReflectanceInfo;uniform vec4 vSpecularColor;uniform vec3 vSpecularAnisotropy;uniform float vCoatWeight;uniform vec3 vCoatColor;uniform float vCoatRoughness;uniform float vCoatRoughnessAnisotropy;uniform float vCoatIor;uniform float vCoatDarkening;uniform float vFuzzWeight;uniform vec3 vFuzzColor;uniform float vFuzzRoughness;uniform vec2 vGeometryCoatTangent;uniform vec3 vEmissionColor;uniform float vThinFilmWeight;uniform vec2 vThinFilmThickness;uniform float vThinFilmIor;uniform vec4 vLightingIntensity;uniform float visibility;
#ifdef BASE_COLOR
...
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=n);var r=`openpbrFragmentSamplersDeclaration`,i=`#include<samplerFragmentDeclaration>(_DEFINENAME_,BASE_COLOR,_VARYINGNAME_,BaseColor,_SAMPLERNAME_,baseColor)
...
#endif
`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=i);var a=`openpbrNormalMapFragmentMainFunctions`,o=`#if defined(GEOMETRY_NORMAL) || defined(GEOMETRY_COAT_NORMAL) || defined(ANISOTROPIC) || defined(FUZZ) || defined(DETAIL)
...
#endif
`;e.IncludesShadersStore[a]||(e.IncludesShadersStore[a]=o);var s=`openpbrNormalMapFragmentFunctions`,c=`#if defined(GEOMETRY_NORMAL)
...
#endif
`;e.IncludesShadersStore[s]||(e.IncludesShadersStore[s]=c);var l=`openpbrDielectricReflectance`,u=`struct ReflectanceParams
...
`;e.IncludesShadersStore[l]||(e.IncludesShadersStore[l]=u);var d=`openpbrConductorReflectance`,f=`#define pbr_inline
...
#endif
outParams.F0=1.0;outParams.F90=1.0;return outParams;}`;e.IncludesShadersStore[d]||(e.IncludesShadersStore[d]=f);var p=`openpbrBlockAmbientOcclusion`,m=`struct ambientOcclusionOutParams
...
`;e.IncludesShadersStore[p]||(e.IncludesShadersStore[p]=m);var h=`openpbrGeometryInfo`,g=`struct geometryInfoOutParams
...
{geometryInfoOutParams geoInfo=geometryInfo(normalW,viewDirectionW,roughness,geometricNormalW);geometryInfoAnisoOutParams outParams;outParams.NdotV=geoInfo.NdotV;outParams.NdotVUnclamped=geoInfo.NdotVUnclamped;outParams.environmentBrdf=geoInfo.environmentBrdf;outParams.horizonOcclusion=geoInfo.horizonOcclusion;outParams.anisotropy=vAnisotropy.b;vec3 anisotropyDirection=vec3(vAnisotropy.xy,0.);mat3 anisoTBN=mat3(normalize(TBN[0]),normalize(TBN[1]),normalize(TBN[2]));outParams.anisotropicTangent=normalize(anisoTBN*anisotropyDirection);outParams.anisotropicBitangent=normalize(cross(anisoTBN[2],outParams.anisotropicTangent));outParams.TBN=TBN;return outParams;}`;e.IncludesShadersStore[h]||(e.IncludesShadersStore[h]=g);var _=`openpbrIblFunctions`,v=`#ifdef REFLECTION
...
#endif
`;e.IncludesShadersStore[_]||(e.IncludesShadersStore[_]=v);var y=`openpbrNormalMapFragment`,b=`vec2 uvOffset=vec2(0.0,0.0);
...
#endif
`;e.IncludesShadersStore[y]||(e.IncludesShadersStore[y]=b);var x=`openpbrBlockNormalFinal`,S=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;e.IncludesShadersStore[x]||(e.IncludesShadersStore[x]=S);var C=`openpbrBaseLayerData`,w=`vec3 base_color=vec3(0.8);float base_metalness=0.0;float base_diffuse_roughness=0.0;float specular_weight=1.0;float specular_roughness=0.3;vec3 specular_color=vec3(1.0);float specular_roughness_anisotropy=0.0;float specular_ior=1.5;float alpha=1.0;vec2 geometry_tangent=vec2(1.0,0.0);
#ifdef BASE_WEIGHT
...
#endif
`;e.IncludesShadersStore[C]||(e.IncludesShadersStore[C]=w);var T=`openpbrCoatLayerData`,E=`float coat_weight=0.0;vec3 coat_color=vec3(1.0);float coat_roughness=0.0;float coat_roughness_anisotropy=0.0;float coat_ior=1.6;float coat_darkening=1.0;vec2 geometry_coat_tangent=vec2(1.0,0.0);
#ifdef COAT_WEIGHT
...
#endif
`;e.IncludesShadersStore[T]||(e.IncludesShadersStore[T]=E);var D=`openpbrThinFilmLayerData`,O=`#ifdef THIN_FILM
...
#endif
#endif
`;e.IncludesShadersStore[D]||(e.IncludesShadersStore[D]=O);var k=`openpbrFuzzLayerData`,A=`float fuzz_weight=0.0;vec3 fuzz_color=vec3(1.0);float fuzz_roughness=0.0;
#ifdef FUZZ
#ifdef FUZZ_WEIGHT
...
#endif
#endif
`;e.IncludesShadersStore[k]||(e.IncludesShadersStore[k]=A);var j=`openpbrEnvironmentLighting`,M=`#ifdef REFLECTION
#ifdef FUZZ
...
#endif
#endif
`;e.IncludesShadersStore[j]||(e.IncludesShadersStore[j]=M);var N=`openpbrDirectLightingInit`,P=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStore[N]||(e.IncludesShadersStore[N]=P);var F=`openpbrDirectLighting`,I=`#ifdef LIGHT{X}
...
#endif
`;e.IncludesShadersStore[F]||(e.IncludesShadersStore[F]=I);var L=`openpbrPixelShader`,R=`#define OPENPBR_FRAGMENT_SHADER
...
`;e.ShadersStore[L]||(e.ShadersStore[L]=R);var z={name:L,shader:R};export{z as openpbrPixelShader};