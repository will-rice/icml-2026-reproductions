...
`+this.showPosition(),{text:``,token:null,line:this.yylineno})},`next`),lex:r(function(){return this.next()||this.lex()},`lex`),begin:r(function(e){this.conditionStack.push(e)},`begin`),popState:r(function(){return this.conditionStack.length-1>0?this.conditionStack.pop():this.conditionStack[0]},`popState`),_currentRules:r(function(){return this.conditionStack.length&&this.conditionStack[this.conditionStack.length-1]?this.conditions[this.conditionStack[this.conditionStack.length-1]].rules:this.conditions.INITIAL.rules},`_currentRules`),topState:r(function(e){return e=this.conditionStack.length-1-Math.abs(e||0),e>=0?this.conditionStack[e]:`INITIAL`},`topState`),pushState:r(function(e){this.begin(e)},`pushState`),stateStackSize:r(function(){return this.conditionStack.length},`stateStackSize`),options:{"case-insensitive":!0},performAction:r(function(e,t,n,r){switch(n){case 0:return this.pushState(`csv`),4;case 1:return this.pushState(`csv`),4;case 2:return 10;case 3:return 5;case 4:return 12;case 5:return this.pushState(`escaped_text`),18;case 6:return 20;case 7:return this.popState(`escaped_text`),18;case 8:return 19}},`anonymous`),rules:[/^(?:sankey-beta\b)/i,/^(?:sankey\b)/i,/^(?:$)/i,/^(?:((\u000D\u000A)|(\u000A)))/i,/^(?:(\u002C))/i,/^(?:(\u0022))/i,/^(?:([\u0020-\u0021\u0023-\u002B\u002D-\u007E])*)/i,/^(?:(\u0022)(?!(\u0022)))/i,/^(?:(([\u0020-\u0021\u0023-\u002B\u002D-\u007E])|(\u002C)|(\u000D)|(\u000A)|(\u0022)(\u0022))*)/i],conditions:{csv:{rules:[2,3,4,5,6,7,8],inclusive:!1},escaped_text:{rules:[7,8],inclusive:!1},INITIAL:{rules:[0,1,2,3,4,5,6,7,8],inclusive:!0}}}})();function o(){this.yy={}}return r(o,`Parser`),o.prototype=a,a.Parser=o,new o})();J.parser=J;var Y=J,X=[],Z=[],Q=new Map,ae=r(()=>{X=[],Z=[],Q=new Map,l()},`clear`),oe=class{constructor(e,t,n=0){this.source=e,this.target=t,this.value=n}static{r(this,`SankeyLink`)}},se=r((e,t,n)=>{X.push(new oe(e,t,n))},`addLink`),ce=class{constructor(e){this.ID=e}static{r(this,`SankeyNode`)}},le={nodesMap:Q,getConfig:r(()=>u().sankey,`getConfig`),getNodes:r(()=>Z,`getNodes`),getLinks:r(()=>X,`getLinks`),getGraph:r(()=>({nodes:Z.map(e=>({id:e.ID})),links:X.map(e=>({source:e.source.ID,target:e.target.ID,value:e.value}))}),`getGraph`),addLink:se,findOrCreateNode:r(e=>{e=d.sanitizeText(e,u());let t=Q.get(e);return t===void 0&&(t=new ce(e),Q.set(e,t),Z.push(t)),t},`findOrCreateNode`),getAccTitle:p,setAccTitle:i,getAccDescription:c,setAccDescription:m,getDiagramTitle:a,setDiagramTitle:s,clear:ae},$=class e{static{r(this,`Uid`)}static{this.count=0}static next(t){return new e(t+ ++e.count)}constructor(e){this.id=e,this.href=`#${e}`}toString(){return`url(`+this.href+`)`}},ue={left:b,right:x,center:C,justify:S},de={draw:r(function(n,i,a,s){let{securityLevel:c,sankey:l}=u(),d=f.sankey,p;c===`sandbox`&&(p=e(`#i`+i));let m=e(c===`sandbox`?p.nodes()[0].contentDocument.body:`body`),g=c===`sandbox`?m.select(`[id="${i}"]`):e(`[id="${i}"]`),_=l?.width??d.width,v=l?.height??d.width,y=l?.useMaxWidth??d.useMaxWidth,b=l?.nodeAlignment??d.nodeAlignment,x=l?.prefix??d.prefix,S=l?.suffix??d.suffix,C=l?.showValues??d.showValues,w=s.db.getGraph(),T=ue[b];P().nodeId(e=>e.id).nodeWidth(10).nodePadding(10+(C?15:0)).nodeAlign(T).extent([[0,0],[_,v]])(w);let E=t(h);g.append(`g`).attr(`class`,`nodes`).selectAll(`.node`).data(w.nodes).join(`g`).attr(`class`,`node`).attr(`id`,e=>(e.uid=$.next(`node-`)).id).attr(`transform`,function(e){return`translate(`+e.x0+`,`+e.y0+`)`}).attr(`x`,e=>e.x0).attr(`y`,e=>e.y0).append(`rect`).attr(`height`,e=>e.y1-e.y0).attr(`width`,e=>e.x1-e.x0).attr(`fill`,e=>E(e.id));let D=r(({id:e,value:t})=>C?`${e}
${x}${Math.round(t*100)/100}${S}`:e,`getText`);g.append(`g`).attr(`class`,`node-labels`).attr(`font-size`,14).selectAll(`text`).data(w.nodes).join(`text`).attr(`x`,e=>e.x0<_/2?e.x1+6:e.x0-6).attr(`y`,e=>(e.y1+e.y0)/2).attr(`dy`,`${C?`0`:`0.35`}em`).attr(`text-anchor`,e=>e.x0<_/2?`start`:`end`).text(D);let O=g.append(`g`).attr(`class`,`links`).attr(`fill`,`none`).attr(`stroke-opacity`,.5).selectAll(`.link`).data(w.links).join(`g`).attr(`class`,`link`).style(`mix-blend-mode`,`multiply`),k=l?.linkColor??`gradient`;if(k===`gradient`){let e=O.append(`linearGradient`).attr(`id`,e=>(e.uid=$.next(`linearGradient-`)).id).attr(`gradientUnits`,`userSpaceOnUse`).attr(`x1`,e=>e.source.x1).attr(`x2`,e=>e.target.x0);e.append(`stop`).attr(`offset`,`0%`).attr(`stop-color`,e=>E(e.source.id)),e.append(`stop`).attr(`offset`,`100%`).attr(`stop-color`,e=>E(e.target.id))}let A;switch(k){case`gradient`:A=r(e=>e.uid,`coloring`);break;case`source`:A=r(e=>E(e.source.id),`coloring`);break;case`target`:A=r(e=>E(e.target.id),`coloring`);break;default:A=k}O.append(`path`).attr(`d`,ie()).attr(`stroke`,A).attr(`stroke-width`,e=>Math.max(1,e.width)),o(void 0,g,0,y)},`draw`)},fe=r(e=>e.replaceAll(/^[^\S\n\r]+|[^\S\n\r]+$/g,``).replaceAll(/([\n\r])+/g,`
`).trim(),`prepareTextForParsing`),pe=r(e=>`.label {
