import{t as e}from"./shaderStore-D-XQlhUT.js";var t=`iblShadowSpatialBlurPixelShader`,n=`precision highp sampler2D;
#define PI 3.1415927
...
gl_FragColor=vec4(X.x/X.w,X.y/X.w,X.z/X.w,1.0);}`;e.ShadersStore[t]||(e.ShadersStore[t]=n);var r={name:t,shader:n};export{r as iblShadowSpatialBlurPixelShader};