import{t as e}from"./shaderStore-D-XQlhUT.js";var t=`iblShadowSpatialBlurPixelShader`,n=`#define PI 3.1415927
...
fragmentOutputs.color= vec4f(X.x/X.w,X.y/X.w,X.z/X.w,1.0);}`;e.ShadersStoreWGSL[t]||(e.ShadersStoreWGSL[t]=n);var r={name:t,shader:n};export{r as iblShadowSpatialBlurPixelShaderWGSL};