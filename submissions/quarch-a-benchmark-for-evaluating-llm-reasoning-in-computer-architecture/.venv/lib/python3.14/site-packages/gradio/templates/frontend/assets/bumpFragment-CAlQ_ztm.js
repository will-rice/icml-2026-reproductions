import{t as e}from"./shaderStore-D-XQlhUT.js";import"./samplerFragmentDeclaration-I1t02tES.js";var t=`bumpFragmentMainFunctions`,n=`#if defined(BUMP) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC) || defined(DETAIL)
...
#endif
`;e.IncludesShadersStoreWGSL[t]||(e.IncludesShadersStoreWGSL[t]=n);var r=`bumpFragmentFunctions`,i=`#if defined(BUMP)
...
#endif
`;e.IncludesShadersStoreWGSL[r]||(e.IncludesShadersStoreWGSL[r]=i);var a=`bumpFragment`,o=`var uvOffset: vec2f= vec2f(0.0,0.0);
