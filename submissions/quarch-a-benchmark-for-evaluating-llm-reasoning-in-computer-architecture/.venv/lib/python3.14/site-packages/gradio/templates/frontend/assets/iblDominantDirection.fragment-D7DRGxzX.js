import{t as e}from"./shaderStore-D-XQlhUT.js";import"./helperFunctions-DquCMwzt.js";import"./hdrFilteringFunctions-BkNCmHAK.js";import"./pbrBRDFFunctions-DiT7LTSA.js";var t=`iblDominantDirectionPixelShader`,n=`#include<helperFunctions>
...
lightDir/=vec3f(f32(NUM_SAMPLES));fragmentOutputs.color=vec4f(lightDir,1.0);}`;e.ShadersStoreWGSL[t]||(e.ShadersStoreWGSL[t]=n);var r={name:t,shader:n};export{r as iblDominantDirectionPixelShaderWGSL};