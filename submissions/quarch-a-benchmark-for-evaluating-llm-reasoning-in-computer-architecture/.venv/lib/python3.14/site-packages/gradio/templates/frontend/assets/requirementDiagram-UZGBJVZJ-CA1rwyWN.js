...
`,`getStyles`),b={};r(b,{draw:()=>x});var x=t(async function(t,r,i,a){n.info(`REF0:`),n.info(`Drawing requirement diagram (unified)`,r);let{securityLevel:o,state:s,layout:c}=l(),u=a.db.getData(),d=f(r,o);u.type=a.type,u.layoutAlgorithm=h(c),u.nodeSpacing=s?.nodeSpacing??50,u.rankSpacing=s?.rankSpacing??50,u.markers=[`requirement_contains`,`requirement_arrow`],u.diagramId=r,await m(u,d),e.insertTitle(d,`requirementDiagramTitleText`,s?.titleTopMargin??25,a.db.getDiagramTitle()),p(d,8,`requirementDiagram`,s?.useMaxWidth??!0)},`draw`),S={parser:_,get db(){return new v},renderer:b,styles:y};export{S as diagram};
