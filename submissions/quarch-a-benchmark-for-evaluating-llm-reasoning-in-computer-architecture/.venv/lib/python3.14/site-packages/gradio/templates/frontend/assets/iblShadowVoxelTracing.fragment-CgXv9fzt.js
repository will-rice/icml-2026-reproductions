import{t as e}from"./shaderStore-D-XQlhUT.js";var t=`iblShadowVoxelTracingPixelShader`,n=`precision highp sampler2D;precision highp sampler3D;
#define PI 3.1415927
varying vec2 vUV;
...
#endif
#endif
}`;e.ShadersStore[t]||(e.ShadersStore[t]=n);var r={name:t,shader:n};export{r as iblShadowVoxelTracingPixelShader};