import{t as e}from"./shaderStore-D-XQlhUT.js";import"./clipPlaneFragment-CSA2ud-B.js";import"./bumpFragment-CXPA1fUd.js";import"./samplerFragmentDeclaration-Ddqenr6W.js";import"./helperFunctions-CM1SYQ_G.js";import"./shadowsFragmentFunctions-C_KNiUjW.js";import"./imageProcessingFunctions-BLS7cm_w.js";import"./lightFragment-Df1zfVTQ.js";import"./logDepthDeclaration--laj1kHT.js";import"./fogFragment-D_7zXuQT.js";import"./oitFragment-0kNY9gqU.js";import"./decalFragment-C340LrdL.js";import"./hdrFilteringFunctions-BK6JpkMG.js";import"./pbrBRDFFunctions-C40dSicq.js";import"./pbrDebug-Bc7QUwIL.js";import"./harmonicsFunctions-DQ8vBbkT.js";import"./pbrUboDeclaration-Bew-TKEU.js";var t=`pbrFragmentDeclaration`,n=`uniform vec4 vEyePosition;uniform vec3 vReflectionColor;uniform vec4 vAlbedoColor;uniform float baseWeight;uniform float baseDiffuseRoughness;uniform vec4 vLightingIntensity;uniform vec4 vReflectivityColor;uniform vec4 vMetallicReflectanceFactors;uniform vec3 vEmissiveColor;uniform float visibility;uniform vec3 vAmbientColor;
#ifdef ALBEDO
...
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=n);var r=`samplerFragmentAlternateDeclaration`,i=`#ifdef _DEFINENAME_
...
#endif
`;e.IncludesShadersStore[a]||(e.IncludesShadersStore[a]=o);var s=`pbrBlockAlbedoOpacity`,c=`struct albedoOpacityOutParams
...
`;e.IncludesShadersStore[s]||(e.IncludesShadersStore[s]=c);var l=`pbrBlockReflectivity`,u=`struct reflectivityOutParams
...
`;e.IncludesShadersStore[l]||(e.IncludesShadersStore[l]=u);var d=`pbrBlockAmbientOcclusion`,f=`struct ambientOcclusionOutParams
{vec3 ambientOcclusionColor;
...
`;e.IncludesShadersStore[d]||(e.IncludesShadersStore[d]=f);var p=`pbrBlockAlphaFresnel`,m=`#ifdef ALPHAFRESNEL
...
#endif
#endif
`;e.IncludesShadersStore[p]||(e.IncludesShadersStore[p]=m);var h=`pbrBlockAnisotropic`,g=`#ifdef ANISOTROPIC
...
#endif
`;e.IncludesShadersStore[h]||(e.IncludesShadersStore[h]=g);var _=`pbrBlockReflection`,v=`#ifdef REFLECTION
...
#endif
`;e.IncludesShadersStore[_]||(e.IncludesShadersStore[_]=v);var y=`pbrBlockSheen`,b=`#ifdef SHEEN
...
#endif
`;e.IncludesShadersStore[y]||(e.IncludesShadersStore[y]=b);var x=`pbrBlockClearcoat`,S=`struct clearcoatOutParams
...
return outParams;}
#endif
`;e.IncludesShadersStore[x]||(e.IncludesShadersStore[x]=S);var C=`pbrBlockIridescence`,w=`struct iridescenceOutParams
...
#endif
`;e.IncludesShadersStore[C]||(e.IncludesShadersStore[C]=w);var T=`pbrBlockSubSurface`,E=`struct subSurfaceOutParams
...
return outParams;}
#endif
`;e.IncludesShadersStore[T]||(e.IncludesShadersStore[T]=E);var D=`pbrBlockReflectance0`,O=`float reflectanceF0=reflectivityOut.reflectanceF0;vec3 specularEnvironmentR0=reflectivityOut.colorReflectanceF0;vec3 specularEnvironmentR90=reflectivityOut.colorReflectanceF90;
#ifdef ALPHAFRESNEL
float reflectance90=fresnelGrazingReflectance(reflectanceF0);specularEnvironmentR90=specularEnvironmentR90*reflectance90;
#endif
`;e.IncludesShadersStore[D]||(e.IncludesShadersStore[D]=O);var k=`pbrClusteredLightingFunctions`,A=`#if defined(CLUSTLIGHT_BATCH) && CLUSTLIGHT_BATCH>0
...
return result;}
#endif
`;e.IncludesShadersStore[k]||(e.IncludesShadersStore[k]=A);var j=`pbrBlockNormalFinal`,M=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;e.IncludesShadersStore[j]||(e.IncludesShadersStore[j]=M);var N=`pbrBlockLightmapInit`,P=`#ifdef LIGHTMAP
...
#endif
`;e.IncludesShadersStore[N]||(e.IncludesShadersStore[N]=P);var F=`pbrBlockGeometryInfo`,I=`float NdotVUnclamped=dot(normalW,viewDirectionW);float NdotV=absEps(NdotVUnclamped);float alphaG=convertRoughnessToAverageSlope(roughness);vec2 AARoughnessFactors=getAARoughnessFactors(normalW.xyz);
#ifdef SPECULARAA
...
#endif
#endif
`;e.IncludesShadersStore[F]||(e.IncludesShadersStore[F]=I);var L=`pbrBlockReflectance`,R=`#if defined(ENVIRONMENTBRDF) && !defined(REFLECTIONMAP_SKYBOX)
...
#endif
#endif
`;e.IncludesShadersStore[L]||(e.IncludesShadersStore[L]=R);var z=`pbrBlockDirectLighting`,B=`vec3 diffuseBase=vec3(0.,0.,0.);
#ifdef SS_TRANSLUCENCY
...
#endif
`;e.IncludesShadersStore[z]||(e.IncludesShadersStore[z]=B);var V=`pbrBlockFinalLitComponents`,H=`aggShadow=aggShadow/numLights;
#if defined(ENVIRONMENTBRDF)
...
#endif
#endif
`;e.IncludesShadersStore[V]||(e.IncludesShadersStore[V]=H);var U=`pbrBlockFinalUnlitComponents`,W=`vec3 finalDiffuse=diffuseBase;finalDiffuse*=surfaceAlbedo;
...
`;e.IncludesShadersStore[U]||(e.IncludesShadersStore[U]=W);var G=`pbrBlockFinalColorComposition`,K=`vec4 finalColor=vec4(
#ifndef UNLIT
#ifdef REFLECTION
finalIrradiance +
#endif
...
`;e.IncludesShadersStore[G]||(e.IncludesShadersStore[G]=K);var q=`pbrPixelShader`,J=`#define PBR_FRAGMENT_SHADER
...
`;e.ShadersStore[q]||(e.ShadersStore[q]=J);var Y={name:q,shader:J};export{Y as pbrPixelShader};