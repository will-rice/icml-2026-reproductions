import{t as e}from"./shaderStore-D-XQlhUT.js";var t=`iblGenerateVoxelMipPixelShader`,n=`varying vUV: vec2f;var srcMip: texture_3d<f32>;uniform layerNum: i32;@fragment
...
<< 7u);fragmentOutputs.color=vec4f( f32(tex)/255.0f,0.0f,0.0f,1.0);}`;e.ShadersStoreWGSL[t]||(e.ShadersStoreWGSL[t]=n);var r={name:t,shader:n};export{r as iblGenerateVoxelMipPixelShaderWGSL};