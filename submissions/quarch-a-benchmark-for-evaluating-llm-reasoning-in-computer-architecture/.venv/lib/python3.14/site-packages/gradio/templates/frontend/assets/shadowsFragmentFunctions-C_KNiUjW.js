import{t as e}from"./shaderStore-D-XQlhUT.js";var t=`reflectionFunction`,n=`vec3 computeFixedEquirectangularCoords(vec4 worldPos,vec3 worldNormal,vec3 direction)
...
#endif
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=n);var r=`lightFragmentDeclaration`,i=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=i);var a=`lightUboDeclaration`,o=`#ifdef LIGHT{X}
uniform Light{X}
...
#endif
result.Diffuse=LTCEvaluate( normal,viewDir,position,mat3( 1.0 ),rectCoords );return result;}`;e.IncludesShadersStore[s]||(e.IncludesShadersStore[s]=c);var l=`shadowsFragmentFunctions`,u=`#ifdef SHADOWS
