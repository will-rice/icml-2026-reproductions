import{t as e}from"./shaderStore-D-XQlhUT.js";import"./helperFunctions-DquCMwzt.js";import"./shadowsFragmentFunctions-BgJ0vxEO.js";import"./imageProcessingFunctions-CeTUCCB6.js";import"./logDepthDeclaration-B8O1rFmO.js";import"./clipPlaneFragment-DGqZJNeS.js";import"./fogFragment-DT_vR29_.js";import"./oitFragment-CawmeOig.js";import"./samplerFragmentDeclaration-I1t02tES.js";import"./hdrFilteringFunctions-BkNCmHAK.js";import"./pbrBRDFFunctions-DiT7LTSA.js";import"./openpbrUboDeclaration-DDVgYCbX.js";import"./pbrDebug-Dcenycev.js";import"./harmonicsFunctions-CteL0VSC.js";var t=`openpbrFragmentSamplersDeclaration`,n=`#include<samplerFragmentDeclaration>(_DEFINENAME_,BASE_COLOR,_VARYINGNAME_,BaseColor,_SAMPLERNAME_,baseColor)
...
#endif
`;e.IncludesShadersStoreWGSL[t]||(e.IncludesShadersStoreWGSL[t]=n);var r=`openpbrNormalMapFragmentMainFunctions`,i=`#if defined(GEOMETRY_NORMAL) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC) || defined(FUZZ) || defined(DETAIL)
...
#endif
`;e.IncludesShadersStoreWGSL[r]||(e.IncludesShadersStoreWGSL[r]=i);var a=`openpbrNormalMapFragmentFunctions`,o=`#if defined(GEOMETRY_NORMAL)
...
#endif
`;e.IncludesShadersStoreWGSL[a]||(e.IncludesShadersStoreWGSL[a]=o);var s=`openpbrDielectricReflectance`,c=`struct ReflectanceParams
{F0: f32,
F90: f32,
coloredF0: vec3f,
coloredF90: vec3f,};
...
`;e.IncludesShadersStoreWGSL[s]||(e.IncludesShadersStoreWGSL[s]=c);var l=`openpbrConductorReflectance`,u=`#define pbr_inline
...
#endif
outParams.F0=1.0f;outParams.F90=1.0f;return outParams;}`;e.IncludesShadersStoreWGSL[l]||(e.IncludesShadersStoreWGSL[l]=u);var d=`openpbrBlockAmbientOcclusion`,f=`struct ambientOcclusionOutParams
...
`;e.IncludesShadersStoreWGSL[d]||(e.IncludesShadersStoreWGSL[d]=f);var p=`openpbrGeometryInfo`,m=`struct geometryInfoOutParams
{NdotV: f32,
NdotVUnclamped: f32,
...
`;e.IncludesShadersStoreWGSL[p]||(e.IncludesShadersStoreWGSL[p]=m);var h=`openpbrIblFunctions`,g=`#ifdef REFLECTION
fn sampleIrradiance(
surfaceNormal: vec3f
...
#endif
`;e.IncludesShadersStoreWGSL[h]||(e.IncludesShadersStoreWGSL[h]=g);var _=`openpbrNormalMapFragment`,v=`var uvOffset: vec2f= vec2f(0.0,0.0);
...
#endif
`;e.IncludesShadersStoreWGSL[_]||(e.IncludesShadersStoreWGSL[_]=v);var y=`openpbrBlockNormalFinal`,b=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[y]||(e.IncludesShadersStoreWGSL[y]=b);var x=`openpbrBaseLayerData`,S=`var base_color=vec3f(0.8);var base_metalness: f32=0.0;var base_diffuse_roughness: f32=0.0;var specular_weight: f32=1.0;var specular_roughness: f32=0.3;var specular_color: vec3f=vec3f(1.0);var specular_roughness_anisotropy: f32=0.0;var specular_ior: f32=1.5;var alpha: f32=1.0;var geometry_tangent: vec2f=vec2f(1.0,0.0);
#ifdef BASE_WEIGHT
...
#endif
`;e.IncludesShadersStoreWGSL[x]||(e.IncludesShadersStoreWGSL[x]=S);var C=`openpbrCoatLayerData`,w=`var coat_weight: f32=0.0f;var coat_color: vec3f=vec3f(1.0f);var coat_roughness: f32=0.0f;var coat_roughness_anisotropy: f32=0.0f;var coat_ior: f32=1.6f;var coat_darkening: f32=1.0f;var geometry_coat_tangent: vec2f=vec2f(1.0f,0.0f);
#ifdef COAT_WEIGHT
...
#endif
`;e.IncludesShadersStoreWGSL[C]||(e.IncludesShadersStoreWGSL[C]=w);var T=`openpbrThinFilmLayerData`,E=`#ifdef THIN_FILM
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[T]||(e.IncludesShadersStoreWGSL[T]=E);var D=`openpbrFuzzLayerData`,O=`var fuzz_weight: f32=0.0f;var fuzz_color: vec3f=vec3f(1.0);var fuzz_roughness: f32=0.0f;
#ifdef FUZZ
#ifdef FUZZ_WEIGHT
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[D]||(e.IncludesShadersStoreWGSL[D]=O);var k=`openpbrEnvironmentLighting`,A=`#ifdef REFLECTION
#ifdef FUZZ
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[k]||(e.IncludesShadersStoreWGSL[k]=A);var j=`openpbrDirectLightingInit`,M=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[j]||(e.IncludesShadersStoreWGSL[j]=M);var N=`openpbrDirectLighting`,P=`#ifdef LIGHT{X}
...
#endif
`;e.IncludesShadersStoreWGSL[N]||(e.IncludesShadersStoreWGSL[N]=P);var F=`openpbrPixelShader`,I=`#define OPENPBR_FRAGMENT_SHADER
...
`;e.ShadersStoreWGSL[F]||(e.ShadersStoreWGSL[F]=I);var L={name:F,shader:I};export{L as openpbrPixelShaderWGSL};