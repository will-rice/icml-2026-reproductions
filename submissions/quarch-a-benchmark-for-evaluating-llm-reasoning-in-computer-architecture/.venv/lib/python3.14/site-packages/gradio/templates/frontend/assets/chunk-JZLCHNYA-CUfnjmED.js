...
`),i));let o=`<span class="`+(t.isNode?`nodeLabel`:`edgeLabel`)+`" `+(t.labelStyle?`style="`+t.labelStyle+`"`:``)+`>`+a+`</span>`;return r.html(c(o,i)),Ge(r,t.labelStyle),r.style(`display`,`inline-block`),r.style(`padding-right`,`1px`),r.style(`white-space`,`nowrap`),r.attr(`xmlns`,`http://www.w3.org/1999/xhtml`),n.node()}a(Ke,`addHtmlLabel`);var qe=a(async(e,t,r,i)=>{let a=e||``;if(typeof a==`object`&&(a=a[0]),m(f().flowchart.htmlLabels))return a=a.replace(/\\n|\n/g,`<br />`),o.info(`vertexText`+a),await Ke({isNode:i,label:n(a).replace(/fa[blrs]?:fa-[\w-]+/g,e=>`<i class='${e.replace(`:`,` `)}'></i>`),labelStyle:t&&t.replace(`fill:`,`color:`)});{let e=document.createElementNS(`http://www.w3.org/2000/svg`,`text`);e.setAttribute(`style`,t.replace(`color:`,`fill:`));let n=[];n=typeof a==`string`?a.split(/\\n|\n|<br\s*\/?>/gi):Array.isArray(a)?a:[];for(let t of n){let n=document.createElementNS(`http://www.w3.org/2000/svg`,`tspan`);n.setAttributeNS(`http://www.w3.org/XML/1998/namespace`,`xml:space`,`preserve`),n.setAttribute(`dy`,`1em`),n.setAttribute(`x`,`0`),r?n.setAttribute(`class`,`title-row`):n.setAttribute(`class`,`row`),n.textContent=t.trim(),e.appendChild(n)}return e}},`createLabel`),q=a((e,t,n,r,i)=>[`M`,e+i,t,`H`,e+n-i,`A`,i,i,0,0,1,e+n,t+i,`V`,t+r-i,`A`,i,i,0,0,1,e+n-i,t+r,`H`,e+i,`A`,i,i,0,0,1,e,t+r-i,`V`,t+i,`A`,i,i,0,0,1,e+i,t,`Z`].join(` `),`createRoundedRectPathD`),Je=a(async(t,n)=>{o.info(`Creating subgraph rect for `,n.id,n);let r=f(),{themeVariables:i,handDrawnSeed:a}=r,{clusterBkg:s,clusterBorder:c}=i,{labelStyles:l,nodeStyles:u,borderStyles:d,backgroundStyles:p}=x(n),h=t.insert(`g`).attr(`class`,`cluster `+n.cssClasses).attr(`id`,n.id).attr(`data-look`,n.look),g=m(r.flowchart.htmlLabels),v=h.insert(`g`).attr(`class`,`cluster-label `),S=await _(v,n.label,{style:n.labelStyle,useHtmlLabels:g,isNode:!0}),C=S.getBBox();if(m(r.flowchart.htmlLabels)){let t=S.children[0],n=e(S);C=t.getBoundingClientRect(),n.attr(`width`,C.width),n.attr(`height`,C.height)}let w=n.width<=C.width+n.padding?C.width+n.padding:n.width;n.width<=C.width+n.padding?n.diff=(w-n.width)/2-n.padding:n.diff=-n.padding;let T=n.height,E=n.x-w/2,D=n.y-T/2;o.trace(`Data `,n,JSON.stringify(n));let O;if(n.look===`handDrawn`){let e=V.svg(h),t=b(n,{roughness:.7,fill:s,stroke:c,fillWeight:3,seed:a}),r=e.path(q(E,D,w,T,0),t);O=h.insert(()=>(o.debug(`Rough node insert CXC`,r),r),`:first-child`),O.select(`path:nth-child(2)`).attr(`style`,d.join(`;`)),O.select(`path`).attr(`style`,p.join(`;`).replace(`fill`,`stroke`))}else O=h.insert(`rect`,`:first-child`),O.attr(`style`,u).attr(`rx`,n.rx).attr(`ry`,n.ry).attr(`x`,E).attr(`y`,D).attr(`width`,w).attr(`height`,T);let{subGraphTitleTopMargin:k}=y(r);if(v.attr(`transform`,`translate(${n.x-C.width/2}, ${n.y-n.height/2+k})`),l){let e=v.select(`span`);e&&e.attr(`style`,l)}let A=O.node().getBBox();return n.offsetX=0,n.width=A.width,n.height=A.height,n.offsetY=C.height-n.padding/2,n.intersect=function(e){return We(n,e)},{cluster:h,labelBBox:C}},`rect`),Ye={rect:Je,squareRect:Je,roundedWithTitle:a(async(t,n)=>{let r=f(),{themeVariables:i,handDrawnSeed:a}=r,{altBackground:o,compositeBackground:s,compositeTitleBackground:c,nodeBorder:l}=i,u=t.insert(`g`).attr(`class`,n.cssClasses).attr(`id`,n.id).attr(`data-id`,n.id).attr(`data-look`,n.look),d=u.insert(`g`,`:first-child`),p=u.insert(`g`).attr(`class`,`cluster-label`),h=u.append(`rect`),g=p.node().appendChild(await qe(n.label,n.labelStyle,void 0,!0)),_=g.getBBox();if(m(r.flowchart.htmlLabels)){let t=g.children[0],n=e(g);_=t.getBoundingClientRect(),n.attr(`width`,_.width),n.attr(`height`,_.height)}let v=0*n.padding,y=v/2,b=(n.width<=_.width+n.padding?_.width+n.padding:n.width)+v;n.width<=_.width+n.padding?n.diff=(b-n.width)/2-n.padding:n.diff=-n.padding;let x=n.height+v,S=n.height+v-_.height-6,C=n.x-b/2,w=n.y-x/2;n.width=b;let T=n.y-n.height/2-y+_.height+2,E;if(n.look===`handDrawn`){let e=n.cssClasses.includes(`statediagram-cluster-alt`),t=V.svg(u),r=n.rx||n.ry?t.path(q(C,w,b,x,10),{roughness:.7,fill:c,fillStyle:`solid`,stroke:l,seed:a}):t.rectangle(C,w,b,x,{seed:a});E=u.insert(()=>r,`:first-child`);let i=t.rectangle(C,T,b,S,{fill:e?o:s,fillStyle:e?`hachure`:`solid`,stroke:l,seed:a});E=u.insert(()=>r,`:first-child`),h=u.insert(()=>i)}else E=d.insert(`rect`,`:first-child`),E.attr(`class`,`outer`).attr(`x`,C).attr(`y`,w).attr(`width`,b).attr(`height`,x).attr(`data-look`,n.look),h.attr(`class`,`inner`).attr(`x`,C).attr(`y`,T).attr(`width`,b).attr(`height`,S);return p.attr(`transform`,`translate(${n.x-_.width/2}, ${w+1-(m(r.flowchart.htmlLabels)?0:3)})`),n.height=E.node().getBBox().height,n.offsetX=0,n.offsetY=_.height-n.padding/2,n.labelBBox=_,n.intersect=function(e){return We(n,e)},{cluster:u,labelBBox:_}},`roundedWithTitle`),noteGroup:a((e,t)=>{let n=e.insert(`g`).attr(`class`,`note-cluster`).attr(`id`,t.id),r=n.insert(`rect`,`:first-child`),i=0*t.padding,a=i/2;r.attr(`rx`,t.rx).attr(`ry`,t.ry).attr(`x`,t.x-t.width/2-a).attr(`y`,t.y-t.height/2-a).attr(`width`,t.width+i).attr(`height`,t.height+i).attr(`fill`,`none`);let o=r.node().getBBox();return t.width=o.width,t.height=o.height,t.intersect=function(e){return We(t,e)},{cluster:n,labelBBox:{width:0,height:0}}},`noteGroup`),divider:a((e,t)=>{let{themeVariables:n,handDrawnSeed:r}=f(),{nodeBorder:i}=n,a=e.insert(`g`).attr(`class`,t.cssClasses).attr(`id`,t.id).attr(`data-look`,t.look),o=a.insert(`g`,`:first-child`),s=0*t.padding,c=t.width+s;t.diff=-t.padding;let l=t.height+s,u=t.x-c/2,d=t.y-l/2;t.width=c;let p;if(t.look===`handDrawn`){let e=V.svg(a).rectangle(u,d,c,l,{fill:`lightgrey`,roughness:.5,strokeLineDash:[5],stroke:i,seed:r});p=a.insert(()=>e,`:first-child`)}else p=o.insert(`rect`,`:first-child`),p.attr(`class`,`divider`).attr(`x`,u).attr(`y`,d).attr(`width`,c).attr(`height`,l).attr(`data-look`,t.look);return t.height=p.node().getBBox().height,t.offsetX=0,t.offsetY=0,t.intersect=function(e){return We(t,e)},{cluster:a,labelBBox:{}}},`divider`),kanbanSection:a(async(t,n)=>{o.info(`Creating subgraph rect for `,n.id,n);let r=f(),{themeVariables:i,handDrawnSeed:a}=r,{clusterBkg:s,clusterBorder:c}=i,{labelStyles:l,nodeStyles:u,borderStyles:d,backgroundStyles:p}=x(n),h=t.insert(`g`).attr(`class`,`cluster `+n.cssClasses).attr(`id`,n.id).attr(`data-look`,n.look),g=m(r.flowchart.htmlLabels),v=h.insert(`g`).attr(`class`,`cluster-label `),S=await _(v,n.label,{style:n.labelStyle,useHtmlLabels:g,isNode:!0,width:n.width}),C=S.getBBox();if(m(r.flowchart.htmlLabels)){let t=S.children[0],n=e(S);C=t.getBoundingClientRect(),n.attr(`width`,C.width),n.attr(`height`,C.height)}let w=n.width<=C.width+n.padding?C.width+n.padding:n.width;n.width<=C.width+n.padding?n.diff=(w-n.width)/2-n.padding:n.diff=-n.padding;let T=n.height,E=n.x-w/2,D=n.y-T/2;o.trace(`Data `,n,JSON.stringify(n));let O;if(n.look===`handDrawn`){let e=V.svg(h),t=b(n,{roughness:.7,fill:s,stroke:c,fillWeight:4,seed:a}),r=e.path(q(E,D,w,T,n.rx),t);O=h.insert(()=>(o.debug(`Rough node insert CXC`,r),r),`:first-child`),O.select(`path:nth-child(2)`).attr(`style`,d.join(`;`)),O.select(`path`).attr(`style`,p.join(`;`).replace(`fill`,`stroke`))}else O=h.insert(`rect`,`:first-child`),O.attr(`style`,u).attr(`rx`,n.rx).attr(`ry`,n.ry).attr(`x`,E).attr(`y`,D).attr(`width`,w).attr(`height`,T);let{subGraphTitleTopMargin:k}=y(r);if(v.attr(`transform`,`translate(${n.x-C.width/2}, ${n.y-n.height/2+k})`),l){let e=v.select(`span`);e&&e.attr(`style`,l)}let A=O.node().getBBox();return n.offsetX=0,n.width=A.width,n.height=A.height,n.offsetY=C.height-n.padding/2,n.intersect=function(e){return We(n,e)},{cluster:h,labelBBox:C}},`kanbanSection`)},Xe=new Map,Ze=a(async(e,t)=>{let n=await Ye[t.shape||`rect`](e,t);return Xe.set(t.id,n),n},`insertCluster`),Qe=a(()=>{Xe=new Map},`clear`);function $e(e,t){return e.intersect(t)}a($e,`intersectNode`);var et=$e;function tt(e,t,n,r){var i=e.x,a=e.y,o=i-r.x,s=a-r.y,c=Math.sqrt(t*t*s*s+n*n*o*o),l=Math.abs(t*n*o/c);r.x<i&&(l=-l);var u=Math.abs(t*n*s/c);return r.y<a&&(u=-u),{x:i+l,y:a+u}}a(tt,`intersectEllipse`);var nt=tt;function rt(e,t,n){return nt(e,t,t,n)}a(rt,`intersectCircle`);var it=rt;function at(e,t,n,r){{let i=t.y-e.y,a=e.x-t.x,o=t.x*e.y-e.x*t.y,s=i*n.x+a*n.y+o,c=i*r.x+a*r.y+o,l=1e-6;if(s!==0&&c!==0&&ot(s,c))return;let u=r.y-n.y,d=n.x-r.x,f=r.x*n.y-n.x*r.y,p=u*e.x+d*e.y+f,m=u*t.x+d*t.y+f;if(Math.abs(p)<l&&Math.abs(m)<l&&ot(p,m))return;let h=i*d-u*a;if(h===0)return;let g=Math.abs(h/2),_=a*f-d*o,v=_<0?(_-g)/h:(_+g)/h;return _=u*o-i*f,{x:v,y:_<0?(_-g)/h:(_+g)/h}}}a(at,`intersectLine`);function ot(e,t){return e*t>0}a(ot,`sameSign`);var st=at;function ct(e,t,n){let r=e.x,i=e.y,a=[],o=1/0,s=1/0;typeof t.forEach==`function`?t.forEach(function(e){o=Math.min(o,e.x),s=Math.min(s,e.y)}):(o=Math.min(o,t.x),s=Math.min(s,t.y));let c=r-e.width/2-o,l=i-e.height/2-s;for(let r=0;r<t.length;r++){let i=t[r],o=t[r<t.length-1?r+1:0],s=st(e,n,{x:c+i.x,y:l+i.y},{x:c+o.x,y:l+o.y});s&&a.push(s)}return a.length?(a.length>1&&a.sort(function(e,t){let r=e.x-n.x,i=e.y-n.y,a=Math.sqrt(r*r+i*i),o=t.x-n.x,s=t.y-n.y,c=Math.sqrt(o*o+s*s);return a<c?-1:a===c?0:1}),a[0]):e}a(ct,`intersectPolygon`);var J={node:et,circle:it,ellipse:nt,polygon:ct,rect:We};function lt(e,t){let{labelStyles:n}=x(t);t.labelStyle=n;let i=W(t),a=i;i||(a=`anchor`);let s=e.insert(`g`).attr(`class`,a).attr(`id`,t.domId||t.id),{cssStyles:c}=t,l=V.svg(s),u=b(t,{fill:`black`,stroke:`none`,fillStyle:`solid`});t.look!==`handDrawn`&&(u.roughness=0);let d=l.circle(0,0,2,u),f=s.insert(()=>d,`:first-child`);return f.attr(`class`,`anchor`).attr(`style`,r(c)),U(t,f),t.intersect=function(e){return o.info(`Circle intersect`,t,1,e),J.circle(t,1,e)},s}a(lt,`anchor`);function ut(e,t,n,r,i,a,o){let s=(e+n)/2,c=(t+r)/2,l=Math.atan2(r-t,n-e),u=(n-e)/2,d=(r-t)/2,f=u/i,p=d/a,m=Math.sqrt(f**2+p**2);if(m>1)throw Error(`The given radii are too small to create an arc between the points.`);let h=Math.sqrt(1-m**2),g=s+h*a*Math.sin(l)*(o?-1:1),_=c-h*i*Math.cos(l)*(o?-1:1),v=Math.atan2((t-_)/a,(e-g)/i),y=Math.atan2((r-_)/a,(n-g)/i)-v;o&&y<0&&(y+=2*Math.PI),!o&&y>0&&(y-=2*Math.PI);let b=[];for(let e=0;e<20;e++){let t=v+e/19*y,n=g+i*Math.cos(t),r=_+a*Math.sin(t);b.push({x:n,y:r})}return b}a(ut,`generateArcPoints`);async function dt(e,t){let{labelStyles:n,nodeStyles:r}=x(t);t.labelStyle=n;let{shapeSvg:i,bbox:a}=await H(e,t,W(t)),o=a.width+t.padding+20,s=a.height+t.padding,c=s/2,l=c/(2.5+s/50),{cssStyles:u}=t,d=[{x:o/2,y:-s/2},{x:-o/2,y:-s/2},...ut(-o/2,-s/2,-o/2,s/2,l,c,!1),{x:o/2,y:s/2},...ut(o/2,s/2,o/2,-s/2,l,c,!0)],f=V.svg(i),p=b(t,{});t.look!==`handDrawn`&&(p.roughness=0,p.fillStyle=`solid`);let m=G(d),h=f.path(m,p),g=i.insert(()=>h,`:first-child`);return g.attr(`class`,`basic label-container`),u&&t.look!==`handDrawn`&&g.selectAll(`path`).attr(`style`,u),r&&t.look!==`handDrawn`&&g.selectAll(`path`).attr(`style`,r),g.attr(`transform`,`translate(${l/2}, 0)`),U(t,g),t.intersect=function(e){return J.polygon(t,d,e)},i}a(dt,`bowTieRect`);function Y(e,t,n,r){return e.insert(`polygon`,`:first-child`).attr(`points`,r.map(function(e){return e.x+`,`+e.y}).join(` `)).attr(`class`,`label-container`).attr(`transform`,`translate(`+-t/2+`,`+n/2+`)`)}a(Y,`insertPolygonShape`);async function ft(e,t){let{labelStyles:n,nodeStyles:r}=x(t);t.labelStyle=n;let{shapeSvg:i,bbox:a}=await H(e,t,W(t)),o=a.height+t.padding,s=a.width+t.padding+12,c=s,l=-o,u=[{x:12,y:l},{x:c,y:l},{x:c,y:0},{x:0,y:0},{x:0,y:l+12},{x:12,y:l}],d,{cssStyles:f}=t;if(t.look===`handDrawn`){let e=V.svg(i),n=b(t,{}),r=G(u),a=e.path(r,n);d=i.insert(()=>a,`:first-child`).attr(`transform`,`translate(${-s/2}, ${o/2})`),f&&d.attr(`style`,f)}else d=Y(i,s,o,u);return r&&d.attr(`style`,r),U(t,d),t.intersect=function(e){return J.polygon(t,u,e)},i}a(ft,`card`);function pt(e,t){let{nodeStyles:n}=x(t);t.label=``;let r=e.insert(`g`).attr(`class`,W(t)).attr(`id`,t.domId??t.id),{cssStyles:i}=t,a=Math.max(28,t.width??0),o=[{x:0,y:a/2},{x:a/2,y:0},{x:0,y:-a/2},{x:-a/2,y:0}],s=V.svg(r),c=b(t,{});t.look!==`handDrawn`&&(c.roughness=0,c.fillStyle=`solid`);let l=G(o),u=s.path(l,c),d=r.insert(()=>u,`:first-child`);return i&&t.look!==`handDrawn`&&d.selectAll(`path`).attr(`style`,i),n&&t.look!==`handDrawn`&&d.selectAll(`path`).attr(`style`,n),t.width=28,t.height=28,t.intersect=function(e){return J.polygon(t,o,e)},r}a(pt,`choice`);async function mt(e,t,n){let{labelStyles:i,nodeStyles:a}=x(t);t.labelStyle=i;let{shapeSvg:s,bbox:c,halfPadding:l}=await H(e,t,W(t)),u=n?.padding??l,d=c.width/2+u,f,{cssStyles:p}=t;if(t.look===`handDrawn`){let e=V.svg(s),n=b(t,{}),i=e.circle(0,0,d*2,n);f=s.insert(()=>i,`:first-child`),f.attr(`class`,`basic label-container`).attr(`style`,r(p))}else f=s.insert(`circle`,`:first-child`).attr(`class`,`basic label-container`).attr(`style`,a).attr(`r`,d).attr(`cx`,0).attr(`cy`,0);return U(t,f),t.calcIntersect=function(e,t){let n=e.width/2;return J.circle(e,n,t)},t.intersect=function(e){return o.info(`Circle intersect`,t,d,e),J.circle(t,d,e)},s}a(mt,`circle`);function ht(e){let t=Math.cos(Math.PI/4),n=Math.sin(Math.PI/4),r=e*2,i={x:r/2*t,y:r/2*n},a={x:-(r/2)*t,y:r/2*n},o={x:-(r/2)*t,y:-(r/2)*n},s={x:r/2*t,y:-(r/2)*n};return`M ${a.x},${a.y} L ${s.x},${s.y}
  ...
  H0 V0 Z`;if(t.look===`handDrawn`){let e=V.svg(a),n=b(t,{}),i=e.path(y,n);v=a.insert(()=>i,`:first-child`),v.attr(`class`,`basic label-container`).attr(`style`,r(p))}else v=a.insert(`path`,`:first-child`).attr(`class`,`basic label-container`).attr(`style`,i).attr(`d`,y);return v.attr(`transform`,`translate(${-g/2}, ${-_/2})`),U(t,v),t.calcIntersect=function(e,t){return J.rect(e,t)},t.intersect=function(e){return o.info(`Bang intersect`,t,e),J.rect(t,e)},a}a(Pn,`bang`);async function Fn(e,t){let{labelStyles:n,nodeStyles:i}=x(t);t.labelStyle=n;let{shapeSvg:a,bbox:s,halfPadding:c,label:l}=await H(e,t,W(t)),u=s.width+2*c,d=s.height+2*c,f=.15*u,p=.25*u,m=.35*u,h=.2*u,{cssStyles:g}=t,_,v=`M0 0
  ...
  H0 V0 Z`;if(t.look===`handDrawn`){let e=V.svg(a),n=b(t,{}),i=e.path(v,n);_=a.insert(()=>i,`:first-child`),_.attr(`class`,`basic label-container`).attr(`style`,r(g))}else _=a.insert(`path`,`:first-child`).attr(`class`,`basic label-container`).attr(`style`,i).attr(`d`,v);return l.attr(`transform`,`translate(${-s.width/2}, ${-s.height/2})`),_.attr(`transform`,`translate(${-u/2}, ${-d/2})`),U(t,_),t.calcIntersect=function(e,t){return J.rect(e,t)},t.intersect=function(e){return o.info(`Cloud intersect`,t,e),J.rect(t,e)},a}a(Fn,`cloud`);async function In(e,t){let{labelStyles:n,nodeStyles:r}=x(t);t.labelStyle=n;let{shapeSvg:i,bbox:a,halfPadding:o,label:s}=await H(e,t,W(t)),c=a.width+8*o,l=a.height+2*o,u=`
    M${-c/2} ${l/2-5}
    v${-l+10}
    q0,-5 5,-5
    h${c-10}
