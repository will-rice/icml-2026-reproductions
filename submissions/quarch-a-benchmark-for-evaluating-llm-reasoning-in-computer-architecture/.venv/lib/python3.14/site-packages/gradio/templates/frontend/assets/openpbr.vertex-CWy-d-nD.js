import{t as e}from"./shaderStore-D-XQlhUT.js";import"./bakedVertexAnimation-ByrDP9UX.js";import"./morphTargetsVertex--kSZKp4V.js";import"./clipPlaneVertex-CGSrwNQT.js";import"./instancesDeclaration-B_vMdLHG.js";import"./helperFunctions-CM1SYQ_G.js";import"./logDepthDeclaration--laj1kHT.js";import"./logDepthVertex-Dj05gqZS.js";import"./shadowsVertex-sGmZ_oSC.js";import"./mainUVVaryingDeclaration-D1A6ESk3.js";import"./vertexColorMixing-TQFn3hiz.js";import"./pbrBRDFFunctions-C40dSicq.js";import"./openpbrUboDeclaration-DumNXqe_.js";import"./harmonicsFunctions-DQ8vBbkT.js";var t=`openpbrVertexDeclaration`,n=`uniform mat4 view;uniform mat4 viewProjection;uniform vec4 vEyePosition;
#ifdef MULTIVIEW
...
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=n);var r=`openpbrNormalMapVertexDeclaration`,i=`#if defined(GEOMETRY_NORMAL) || defined(PARALLAX) || defined(GEOMETRY_COAT_NORMAL) || defined(ANISOTROPIC) || defined(FUZZ)
#if defined(TANGENT) && defined(NORMAL) 
varying mat3 vTBN;
#endif
#endif
`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=i);var a=`openpbrNormalMapVertex`,o=`#if defined(GEOMETRY_NORMAL) || defined(PARALLAX) || defined(GEOMETRY_COAT_NORMAL) || defined(ANISOTROPIC) || defined(FUZZ)
#if defined(TANGENT) && defined(NORMAL)
vec3 tbnNormal=normalize(normalUpdated);vec3 tbnTangent=normalize(tangentUpdated.xyz);vec3 tbnBitangent=cross(tbnNormal,tbnTangent)*tangentUpdated.w;vTBN=mat3(finalWorld)*mat3(tbnTangent,tbnBitangent,tbnNormal);
#endif
#endif
`;e.IncludesShadersStore[a]||(e.IncludesShadersStore[a]=o);var s=`openpbrVertexShader`,c=`#define OPENPBR_VERTEX_SHADER
...
`;e.ShadersStore[s]||(e.ShadersStore[s]=c);var l={name:s,shader:c};export{l as openpbrVertexShader};