import{t as e}from"./shaderStore-D-XQlhUT.js";import"./helperFunctions-CM1SYQ_G.js";var t=`iblCdfyPixelShader`,n=`precision highp sampler2D;precision highp samplerCube;
...
gl_FragColor=vec4(cdfy,0.0,0.0,1.0);}`;e.ShadersStore[t]||(e.ShadersStore[t]=n);var r={name:t,shader:n};export{r as iblCdfyPixelShader};